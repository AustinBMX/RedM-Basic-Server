...
-----------------------Little Creek Ranch
RequestImap(1929440211)--Shack just south of house
...
RemoveImap(-657241692)  --Oil Pipe post fire
RemoveImap(-1112373128)  --Oil Tower post fire
RequestImap(1274804496)--Oil building
RequestImap(1597665303)--Oil Building Interior
RequestImap(116162819)--South area pre-fire
RequestImap(-2133417899)--House being built
RemoveImap(-891994084)--House Built
------------------------------------- #### Heartland Oil Station ####
...
RequestImap(1017355491)--St.Denis Bank Wall
RequestImap(1431947993)
RequestImap(-604091710)
------------------------######END SAINT DENIS BANK
...
------------------------------------- #### END OF CASINO ####
----------------------- Casino boat docked
RequestImap(1056170594)---Ext
RequestImap(-873881483)---Upper Int
RequestImap(881979872)--Lower Int
--RequestImap(1157695860)---Doors
RequestImap(1679182807)---Dock just east Construction
RequestImap(-1512794226)---Dock just east done
RequestImap(146172383)---Ramp to Casino
------------------------------------- #### END OF CASINO DOCKED####
...
-----------------------House between Big Valley and Wallace Station
RequestImap(-37875204)--House Ext
RequestImap(258104717)--House Int
RequestImap(-76700394)--Bushes
RemoveImap(894787561)--grass
...
-----------------------Thives------------------------
RequestImap(-688011628) -- Missing building

-------------------Gypsy Caravan in Rhodes
...
RequestImap(1638937672)--Big TeePee
RequestImap(795060201)--TeePee Door
RequestImap(1003623269)--TeePees
RequestImap(-924329535)--Fires
...
--RequestImap(1372565859)--Thieves landing
...
RegisterCommand("loadinteriors",function()
    getValJail()
    getValBank()
    getValSaloon()
    getValGenstore()
