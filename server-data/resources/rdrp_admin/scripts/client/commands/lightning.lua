...
RegisterNUICallback('smite', function(data, cb)
    data.staff = GetPlayerName(PlayerId())
    TriggerServerEvent('rdrp_admin:smite',data)

end)

RegisterNUICallback('light', function(cb)
    TriggerEvent("lightning-attacks:toggle")
